  ...
  const planView = (
    <div className="plan_item">
      ...
      <div className="plan_btn_container">
        <div className="plan_btn complete_btn" onClick={() => props.onCompleteClick()}>
          완료
        </div>
  ...
  const editableView = (
    <div className="plan_item">
      ...
      <div className="plan_btn_container" style={{justifyContent: "flex-end", marginRight: "2.5px"}}>
        <div className="plan_btn complete_edit_btn" onClick={() => onEditCompleteClick(contents.title, contents.exp, props.id, contents.completed)}>확인</div>
      </div>
    </div>
  );
  return (
