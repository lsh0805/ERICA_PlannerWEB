...
const PlanList =({author, planList, type, date, completed, onEditComplete, onDelete, onCreate}) => {
  ...
  return (
    <div className="plan_box">
      <div className="plan_header">
        <div className="date">{date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate()}</div>
